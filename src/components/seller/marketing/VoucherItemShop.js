...
const VoucherItemShop = (props) => {
    ...
    return (
        <div
            className="flex items-center w-full mb-2 h-[121px] cursor-pointer"
        >
            <div
                className={`${item?.discount_voucher_type_id === 1 ? "bg-emerald-500" : "bg-red-700"
...
export default memo(VoucherItemShop);
