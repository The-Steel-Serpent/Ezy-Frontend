...
const ChatBox = () => {
  ...
  return (
    <div className="fixed right-2 bottom-0 z-[99999] font-[400] cursor-pointer">
      <div
        className={`${
        ...
        <div className="flex h-[460px]">
          <div className="left-chatbox">
            <div className="w-full h-12 flex items-center box-border px-3 py-2">
              <div className="relative w-full h-full text-sm box-border z-10">
                <div className="bg-white border border-solid border-[rgb(229, 229, 229)] border-collapse border-spacing-0 box-border inline-table text-sm h-8 outline-none  px-3 relative transition-all duration-200 ease-in-out w-f"></div>
              </div>
            </div>
          </div>
          <div
